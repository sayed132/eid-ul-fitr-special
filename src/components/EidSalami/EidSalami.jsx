const EidSalami = () => {
  return (
    <div className="">
       ...
       <h1 className="text-start font-semibold text-2xl">সালামি বা ঈদি বা ঈদিয়া হল একটি উপহার বা বকশিশ। <br /> এটি ঈদুল ফিতর ও ঈদুল আযহার সময় ঈদ উদযাপনের অংশ হিসাবে <br /> সাধারণত বড়রা ছোটদেরকে দিয়ে থাকেন।</h1>
       </div>
      <div className=" mx-auto my-20 flex flex-col items-center justify-center md:flex-row">
        <div className="group relative  sm:w-[350px]">
          <img
            ...
            src="https://i.ibb.co/b1XY2gQ/258727252-1247222739124851-3132726739531733063-n-1.jpg"
        ...
        <div className="min-w-[250px] max-w-[350px] space-y-12 rounded-br-lg rounded-tr-lg bg-white p-10 text-center shadow-[0px_7px_30px_2px_rgba(100,100,111,0.2)] dark:bg-[#18181B] md:w-[350px] dark:shadow-[0px_2px_8px_0px_rgba(0,0,0,0.8)]">
          <div className="space-y-1">
            <h2 className="text-center font-sans text-2xl font-medium text-gray-700 dark:text-white/90 lg:text-3xl">
             ঈদের চাঁদ আকাসে সালামি দিন বিকাশে 
            </h2>
          </div>
          <div>
            ...
            <button className="rounded-full border border-[#0d87f8] px-4 py-2 mt-2 text-sm text-[#0d87f8] hover:bg-[#0d87f8] hover:text-white  duration-300 dark:hover:bg-transparent dark:hover:text-[#0d87f8] dark:hover:drop-shadow-[0px_0px_2px_#0d87f8]">
            Nagad: 01824543819
            </button>
          </div>
          <div>
